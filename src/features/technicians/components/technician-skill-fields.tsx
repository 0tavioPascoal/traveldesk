...
export function TechnicianSkillFields({ options, initialValues, disabled, error }: Props) {
  ...
  return <section aria-labelledby="skill-fields-title" className="rounded-2xl border border-border bg-card p-5 sm:p-6">
