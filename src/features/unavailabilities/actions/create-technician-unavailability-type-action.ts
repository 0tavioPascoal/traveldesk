...
import { createTechnicianUnavailabilityType } from "@/features/unavailabilities/application/create-technician-unavailability-type";
...
export async function createTechnicianUnavailabilityTypeAction(
  ...
  const result = await createTechnicianUnavailabilityType(organizationSlug, parsed.data);
